...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference("Publication.count") do
      post publications_url, params: { publication: { cargo: @publication.cargo, description: @publication.description } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { cargo: @publication.cargo, description: @publication.description } }
